...
from openweatherAPI import get_openweather_info  # 为刘天怡增加的Fort Lee 和 NYC 天气
global false, null, true
false = null = true = ''


def get_color(default=True):
    #获取随机颜色
    if default:
        return "#000000"
    else:
...
#推送信息
def send_message(to_user, access_token, weather, lucky_, pipi):
    #pipi, lizhi, health_tip, lucky_
...
if __name__ == "__main__":
    ...
    for user in users:
        ...
        send_message(user, accessToken, weather, lucky_, pipi)
    import time
    time_duration = 3.5
